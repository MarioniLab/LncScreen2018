...
length(intersect(sig.rna, sig.chart)) # In RNA+LNA and CHART 
length(setdiff(sig.rna, sig.chart)) # In RNA+LNA, but not CHART 
length(setdiff(sig.chart, sig.rna)) # In CHART but not RNA+LNA
```
