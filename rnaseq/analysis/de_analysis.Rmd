...
Testing for DE between 271 LNA2-treated cells against those treated with negative control A.

```{r}
fname <- "LNA2_271_vs_NegA"
con <- makeContrasts(
    gLNA.wild_type_genotype.271_LNA2.batch_3
...
Testing for DE between 271 LNA2-treated cells against those treated with negative control B.

```{r}
fname <- "LNA2_271_vs_NegB"
con <- makeContrasts(
    gLNA.wild_type_genotype.271_LNA2.batch_3
...
Testing for DE between 271 LNA3-treated cells against those treated with negative control A.

```{r}
fname <- "LNA3_271_vs_NegA"
con <- makeContrasts(
    gLNA.wild_type_genotype.271_LNA3.batch_3
        - gLNA.wild_type_genotype.Negative_control_A.batch_3,
    levels=design)
colnames(con) <- fname
fit2 <- contrasts.fit(fit, con)
...
Testing for DE between 271 LNA3-treated cells against those treated with negative control B.

```{r}
fname <- "LNA3_271_vs_NegB"
con <- makeContrasts(
    gLNA.wild_type_genotype.271_LNA3.batch_3
        - gLNA.wild_type_genotype.Negative_control_B.batch_3,
    levels=design)
...
out <- CONSFUN(list(
    ...
    LNA2_NegA="results_lfc/LNA2_271_vs_NegA.txt",
    LNA2_NegB="results_lfc/LNA2_271_vs_NegB.txt",
    LNA3_NegA="results_lfc/LNA3_271_vs_NegA.txt",
    LNA3_NegB="results_lfc/LNA3_271_vs_NegB.txt")
)
...
out <- CONSFUN(list(
    ...
    LNA2_NegA="results_de/LNA2_271_vs_NegA.txt",
    LNA2_NegB="results_de/LNA2_271_vs_NegB.txt",
    LNA3_NegA="results_de/LNA3_271_vs_NegA.txt",
    LNA3_NegB="results_de/LNA3_271_vs_NegB.txt")
)
