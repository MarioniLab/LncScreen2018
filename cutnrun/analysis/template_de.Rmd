---
title: DB analysis of H3K4me3 cut-and-run with #_WIDTH_# bp windows
author: Aaron Lun
date: "`r Sys.Date()`"
output:
...
```{r}
bam.files <- c(
    "SLX-15763.iPCRtagT001.CC6ULANXX.s_7.r.bam",
...
We normalize out trended efficiency biases, under the assumption that most histone marking does _not_ change upon lncRNA knockdown.
...
We can create some MA plots to examine the behaviour of the normalization factors.
...
```{r}
saveRDS(file="h3k4me3_#_WIDTH_#.rds", list(windows=rowRanges(filtered), 
