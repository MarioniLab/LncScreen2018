...
library(rtracklayer)
export(con='RNAi_#_MARK_#.bed', db.regions[out$table$FDR<=0.05])
```
...
db.regions$score <- -10*log10(out$table$PValue)
library(rtracklayer)
export(con='LNA_#_MARK_#.bed', db.regions[out$table$FDR<=0.05])
```
...
db.regions$score <- -10*log10(out$table$PValue)
library(rtracklayer)
export(con='Both_#_MARK_#.bed', db.regions[out$table$FDR<=0.05])
```
